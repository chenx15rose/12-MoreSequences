...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  6 black dots.'
    window = rg.RoseWindow(400, 400, title)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  200 slices, thin (thickness=3) black lines on yellow circle'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
...
def run_test_polygon():
    ...
    title = 'POLYGON tests 3:  4 segments with medium black lines on a lime green circle.'
    window = rg.RoseWindow(550, 400, title)
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  300 black lines on yellow circle, hops = 61.'
    window = rg.RoseWindow(480, 350, title)
